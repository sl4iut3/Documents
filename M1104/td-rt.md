...
$$
\colorbox{aqua}{$i_C = C \frac{dV_C}{dt}$}~~\textrm{et}~~\colorbox{aqua}{$v_L=L\frac{di_L}{dt}$}
$$
...
A partir de $t'=0$, la bobine va chercher à maintenir son courant qui circule ($i_2$) pendant un certain temps. Elle va se décharger et au bout d'un certain temps, le courant $i_2$ devient nul.
$$
\lim_{t \to\infty} i_2(t)=0
$$  
Or, d'après la solution générale, on a :
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMTU0NjU0OTYsLTIwOTkzMTg4NTgsLT
c3ODAwMTY2NCwtMTIyNzQ2NjkyOSwyMjUyNjUzNjMsMTE1MjM1
MjkwOSwxNTk4ODYxNzcwLDEyNjU5NjQ0MTksNzIzOTI5Mzc0LC
01MzIzNzgyMTMsMjA4NzA2MjM4NywtODEyMjUxOTc4LDE1ODc4
MjQ4MzcsOTg1NTA4MTQzLDExMzcwOTIwOTRdfQ==
-->